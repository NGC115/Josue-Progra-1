// calculadora funcional.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    case 6:
        ...
        {
            std::cout << VALOR2 << "es mayor que\n" << VALOR1 << std::endl;
        }
        else if (VALOR1 > VALOR2)
        {
            std::cout << VALOR2 << "es menor que\n" << VALOR1 << std::endl;
        }
        break;
